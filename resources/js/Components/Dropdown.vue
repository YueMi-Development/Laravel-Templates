...
const alignmentClasses = computed(() => {
    if (props.align === 'left') {
    ...
    } else if (props.align === 'top' || props.align === 'top-full') {
        return 'origin-bottom bottom-full mb-2 start-0 end-0';
        ...
        return 'ltr:origin-bottom-right rtl:origin-bottom-left end-0 bottom-full mb-2';
    } else {
...
<template>
    <div class="relative">
        ...
        >
            ...
            >
                <div
                    class="overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-xl dark:border-zinc-700/80 dark:bg-zinc-900"
